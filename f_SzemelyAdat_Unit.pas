...
type
  Tf_SzemelyAdat = class(TAlapAblak)
    Label5: TLabel;
    l_nev: TLabel;
    Label1: TLabel;
    Label2: TLabel;
...
procedure Tf_SzemelyAdat.eleresAfterScroll(DataSet: TDataSet);
begin
  inherited;
  ELE_ID:=eleres.FieldByName('eleres_id').AsString;
end;

procedure Tf_SzemelyAdat.eleres_szerk;
var s: Integer;
begin
  s:=BB_BILL;
...
procedure Tf_SzemelyAdat.bb_eleres_modClick(Sender: TObject);
begin
  HIVO:=2;  BB_BILL:=2;
  eleres_szerk;
  inherited;
...
procedure Tf_SzemelyAdat.bb_eleres_ujClick(Sender: TObject);
begin
  HIVO:=1;  BB_BILL:=1;
  eleres_szerk;
  inherited;
...
procedure Tf_SzemelyAdat.bb_felveszClick(Sender: TObject);
var i: Integer;
begin
  i:=BB_BILL;
  inherited;
